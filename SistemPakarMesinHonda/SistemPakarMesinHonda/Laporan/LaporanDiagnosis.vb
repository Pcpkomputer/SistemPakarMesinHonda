...
Public Class LaporanDiagnosis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemPakarMesinHonda.LaporanDiagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDiagnosis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDiagnosis = New LaporanDiagnosis()
        rpt.Site = Me.Site
        Return rpt
    End Function
